...
pub const BLOCK_HEADER_MAGIC: &[u8] = &[b'V', b'E', b'L', b'A', b'B', b'L', b'K', b'1'];
...
pub struct Header {
    ...
    /// Compression size of data segment
    pub data_length: u32,
}
...
impl Deserializable for Header {
    fn deserialize<R: Read>(reader: &mut R) -> Result<Self, DeserializeError> {
        ...
        if magic != BLOCK_HEADER_MAGIC {
            return Err(DeserializeError::InvalidHeader("Block".to_owned()));
        }

        // Read compression type
        let compression = reader.read_u8()?;
        let compression = CompressionType::try_from(compression)
            .map_err(|()| DeserializeError::InvalidTag(Tag("CompressionType".to_owned(), compression)))?;
...
mod tests {
    ...
    fn block_header_raw() -> crate::Result<()> {
        ...
        let bytes = &[
            // Header
            b'V', b'E', b'L', b'A', b'B', b'L', b'K', b'1',
